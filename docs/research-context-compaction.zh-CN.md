...
[English](research-context-compaction.md) · **简体中文**

> 调研日期：2026-09-24。下文以 Claude Code（Claude Opus 5.5，1M 窗口，默认约 967K 自动压缩）和 Codex（约 272K 窗口）为例。下文的"强/中/弱"指证据强弱，标"二手"的表示没拿到原文。
