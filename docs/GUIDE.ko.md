...
출처를 포함한 전체 참고 자료(다른 도구들의 기본값, 공급업체 벤치마크, 블로그 조언, 비용 모델)는 [docs/compaction-threshold-guide.md](compaction-threshold-guide.md)(중국어)에 있습니다.
...
이 팁들은 공개된 연구와 공식 문서를 검토한 결과입니다. 출처를 포함한 전체 노트는 [docs/research-context-compaction.md](research-context-compaction.md)(중국어)에 있습니다. 자동 압축 임계값을 고르는 방법은 [docs/compaction-threshold-guide.md](compaction-threshold-guide.md)(중국어)와 [자동 압축 용량 직접 설정하기](#자동-압축-용량-직접-설정하기)를 참고하세요.
