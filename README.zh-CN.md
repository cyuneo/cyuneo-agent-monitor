...
> **预览版（0.3.1）。** 这是首个公开版本。发现任何不对劲的地方，欢迎到 [GitHub Issues](https://github.com/cyuneo/cyuneo-agent-monitor/issues) 反馈。
...
它只读取 Claude Code 和 Codex 本来就写在你电脑上的记录；扩展本身不联网，不收集任何数据。
