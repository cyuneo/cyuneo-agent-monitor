...
class AgentsViewProvider {
  ...
  resolveWebviewView(view) {
    ...
    // Badge and description set before the view was first shown; apply them once the view exists
  ...
  /** View badge (number of sessions that need you): attached to this webview view; remembered until the view exists */
  setBadge(badge) {
    this.badge = badge;
