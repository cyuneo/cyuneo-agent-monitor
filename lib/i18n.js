...
// - Dictionaries: l10n/<area>.<locale>.json, with fixed areas core, views, webview, cli, compact, storage, push;
...
(function (root, factory) {
  ...
  const REGIONS = Object.freeze(['core', 'views', 'webview', 'cli', 'compact', 'storage', 'push', 'alerts', 'history']);
