...
/**
 * Current usage-limit hits from a QuotaSnapshot (lib/core/quota.js, filled by monitor.js): the lastHit of Claude, Copilot,
 * Gemini and Qwen, and Codex when rate_limit_reached_type is set or a window is at 100 %. The id derives from the data
