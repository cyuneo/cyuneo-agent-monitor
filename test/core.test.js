...
function i18nTests() {
  ...
  test('ten regions × five languages: key sets match English and each key has the same placeholders; same for package.nls', () => {
    ...
    assert.deepStrictEqual([...i18n.REGIONS], ['core', 'views', 'webview', 'cli', 'compact', 'storage', 'push', 'alerts', 'history', 'autoresume']);
